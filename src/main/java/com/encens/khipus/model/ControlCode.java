...
public class ControlCode {
    ...
    public ControlCode(String nitEmpresa,
        ...
        this.importeVentasGrabadas = "0";
        this.importeSujetoCreditoFisical = "0";
        this.descuentosBonificaciones = (valorComision == 0) ? "0" : valorComision.toString();
    }
    ...
    public void generarCodigoQR()
    {
        ...
        NumberFormat nf = NumberFormat.getNumberInstance(US_LOCALE);
        ...
        this.keyQR =  nitEmpresa +"|"+
                ...
                date +"|"+
                df.format(total) +"|"+
                df.format(importeBaseCreditFisical) +"|"+
                codigoControl +"|"+
                nitCliente +"|"+
                importeICE +"|"+
